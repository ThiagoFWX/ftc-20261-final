...
namespace Parte3.models
{
    ...
    {
        public List<EstadoMT> Estados { get; set; }
        ...
        public EstadoMT EstadoAceitacao { get; set; }
        public EstadoMT EstadoRejeicao { get; set; }
        ...
        public TransicaoMT BuscarTransicao(EstadoMT estado, char simbolo)
        {
            ...
            {
                if (transicao.EstadoOrigem.Nome == estado.Nome && transicao.SimboloLido == simbolo)
                {
                    return transicao;
                }
            }
